...
/**
 * Transform course data into course summary.
 *
 * @package    local_dash
 ...
 * @package local_dash
 */
class course_summary_attribute extends abstract_field_attribute {
    /**
    ...
    public function transform_data($data, \stdClass $record) {
        ...
        if ($data && $course = $DB->get_record('course', ['id' => $data])) {
            ...
            $summary = format_text($summary, $course->summaryformat, ['noclean' => true]);
        }
