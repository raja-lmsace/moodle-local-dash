...
class role_name_filter extends select_filter {
    ...
    public function init() {
        ...
        foreach ($records as $id => $roleid) {
            ...
            if ($DB->record_exists('role_names', ['roleid' => $roleid, 'contextid' => $context->id])) {
                $this->add_option($roleid, $DB->get_field('role_names', 'name', array('roleid' => $roleid, 'contextid' => $context->id)));
            } else {
