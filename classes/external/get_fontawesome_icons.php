...
/**
 * Dash - External function to get FontAwesome icons.
 *
 * @package    local_dash
...
/**
 * Provides the local_dash_get_fontawesome_icons external function.
 */
class get_fontawesome_icons extends external_api {
    ...
    public static function execute(string $query): array {
        ...
        // Otherwise, the local_dash_build_fa_icon_map() function will complain.
