...
class activity_grade_table extends table {
    ...
    public function get_fields(): array {
        global $DB;
        $fields = [
            new field('grademax', new lang_string('grademax', 'dashaddon_activity_completion'), $this, 'gt.grademax', [new activity_grademax_attribute()]),
            ...
            new field('currentgrade', new lang_string('currentgrade', 'dashaddon_activity_completion'), $this, 'gg.finalgrade', [new activity_currentgrade_attribute()]),
