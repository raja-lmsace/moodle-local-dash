...
/**
 * Transform activity data into activity completion override date.
 *
...
/**
 * Transforms activity data to formatted activity completion override date.
 *
 * @package dashaddon_activity_completion
 */
class completion_overridedate_attribute extends abstract_field_attribute {
    ...
    public function transform_data($data, \stdClass $record) {
        global $DB;
        if ($record->cmc_completionoverrideby) {
