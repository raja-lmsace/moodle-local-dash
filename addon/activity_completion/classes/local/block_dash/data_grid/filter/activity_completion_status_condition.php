...
class activity_completion_status_condition extends condition {
    ...
    public function get_sql_and_params() {
        ...
        //         "SELECT cmc.userid FROM (
        //            SELECT
        //                 DISTINCT cmc.courseid,
        //                 CASE WHEN cmc.completionstate = 1 THEN 'completed'
        //                     WHEN cmc.completionstate = 0 THEN 'notcompleted'
        //             FROM {course_modules_completion} cmc
        //         WHERE cmd.coursemoduleid = :coursemoduleid
        //         )".$sql, $params
        //     );
