...
Feature: Add activity completion condition datasource in dash block
  ...
  Scenario: Activity completion datasource: Course
    ...
    And I should see "Student 1" in the ".dash-table tbody tr:nth-child(2) td:nth-child(4)" "css_element"
    And I should see "Assignment 3" in the ".dash-table tbody tr:nth-child(7) td:nth-child(2)" "css_element"
  ...
  Scenario Outline: Activity completion: Course date
    ...
    Examples:
      ...
      | past 		 	 | Student 2 | 1		| Assignment 5 | 1 		| C4 		 | 1 		|
      | present 	 | Student 1 | 1  	| Assignment 1 | 1 		| C1 		 | 1 		|
      |	present    | Student 1 | 2 	  | Assignment 2 | 2 		| C1 		 | 2 		|
      |	present  	 | Student 2 | 7		| Assignment 3 | 7 		| C1 		 | 7 		|
      |	present  	 | Student 2 | 8		| Assignment 4 | 8	  | C1 		 | 8 		|
      |	present  	 | Student 3 | 9		| Assignment 1 | 9 		| C1 		 | 9 		|
      |	present  	 | Student 3 | 10		| Assignment 2 | 10		| C1 		 | 10 	|
  ...
  Scenario Outline: Activity completion: Course future date
    ...
    Examples:
      | coursedate | name 		 | Nrow | activity 		 | Arow | course | Crow |
      | future 	 	 | Student 3 | 10		| Assignment 2 | 10   | C1 		 | 10 	|
  ...
  Scenario Outline: Activity completion datasource: activity completion status
    ...
    Examples:
      ...
      | notcompleted | Student 1 | 2 	  | Assignment 2 | 2 	  | C1 		 | 2 	  |
      | notcompleted | Student 2 | 4 	  | Assignment 1 | 4 	  | C1 		 | 4 	  |
      | notcompleted | Student 2 | 5 	  | Assignment 2 | 5  	| C1 		 | 5 	  |
      | notcompleted | Student 3 | 9 	  | Assignment 1 | 9 	  | C1 		 | 9 	  |
      | notcompleted | Student 3 | 10   | Assignment 2 | 10 	| C1 	 	 | 10 	|
