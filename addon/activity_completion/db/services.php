...
$functions = [
    ...
    'dashaddon_activity_completion_override_completion_status' => array(
        'classname' => 'external',
        'methodname' => 'override_completion_status',
        'classpath' => 'local/dash/addon/activity_completion/classes/external.php',
        'description' => 'Override the activity completion status',
        'type' => 'write',
        'ajax' => true
    ),
];