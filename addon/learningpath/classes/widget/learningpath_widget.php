...
class learningpath_widget extends abstract_widget {
    ...
    public function build_widget() {
        ...
        if ($selectedkpi === 'completedcourses') {
        ...
        } else if ($selectedkpi === 'percentagecompleted') {
            ...
            if (!empty($courseids)) {
                ...
                $totalbadges = (int)$DB->count_records_sql($sqltotal, $inparams);
    ...
    /**
     * Get the total completed courses count.
     *
     * @return int $completedcourses
     */
