...
class dashboard extends persistent {
    ...
    public function process_call_action() {
        ...
        if ($ctalink == 'enrolment') {
            ...
            $text = !empty($this->get('ctacustomurltext')) ? $this->get('ctacustomurltext') : get_string('strcustomurl', 'block_dash');
    ...
    public function duplicate() {
        ...
        $DB->set_field('dashaddon_dashboard_dash', 'includedblocks', json_encode($onpagenavigationblocks), ['id' => $newdashboard->get('id')]);
        return $newdashboard;
    }
