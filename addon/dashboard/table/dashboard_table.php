...
class dashboard_table extends \table_sql {
    ...
    public function col_actions($data) {
        ...
        $actions += [
            [
                'url' => new \moodle_url('/local/dash/addon/dashboard/dashboards.php', ['action' => 'duplicate', 'id' => $data->id]),
                'icon' => new \pix_icon('t/copy', \get_string('duplicate')),
                'attributes' => array('class' => 'action-copy'),
                'name' => 'copy',
            ],
            [
                'url' => new \moodle_url('/local/dash/addon/dashboard/dashboards.php', ['action' => 'edit', 'id' => $data->id]),
                'icon' => new \pix_icon('t/edit', \get_string('edit')),
                'attributes' => array('class' => 'action-edit'),
                'name' => 'edit',
            ],
            [
                'url' => new \moodle_url('/local/dash/addon/dashboard/dashboards.php', ['action' => 'delete', 'id' => $data->id]),
