...
class programs_table extends table {
    ...
    public function get_fields(): array {
        ...
        $fields = [
            new field('id', new \lang_string('programs', 'dashaddon_programs'), $this, null, [new identifier_attribute()]),
            ...
            new field(
                ...
                [
                    ...
                    new linked_data_attribute(
                        ['url' => new moodle_url('/enrol/programs/my/index.php', ['contextid' => 'epp_ctx'])]
                    ),
                ]
            ),
