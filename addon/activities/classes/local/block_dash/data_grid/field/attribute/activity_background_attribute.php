 ...
 * @package dashaddon_activities
 */
class activity_background_attribute extends abstract_field_attribute {
    /**
    ...
    public function transform_data($data, \stdClass $record) {
        ...
        $modulebackimageurl = '';
        if (method_exists('local_designer\options', 'get_module_backgroundimage')) {
            $modulebackimageurl = options::get_module_backgroundimage($cm);
