...
Feature: Dash program to show the list of cohort course
  ...
  Scenario: Course information
    ...
    #And "Course information" should exist in the "course" "table"
    #And I should see "Course information" "button" in the "course" "table"
    #Then "//*[contains(button(), 'Course information')]" "xpath_element" should exist in the "course" "table"
